...
import { useProfile, useUpdateProfile, useChangePassword, useVerifyEmailChange } from "@/hooks/useProfile";
...
export default function ProfilePage() {
    ...
    const onProfileSubmit = (values: ProfileFormValues) => {
        ...
        const isEmailChanging = values.email &&
            values.email.toLowerCase() !== currentEmail?.toLowerCase();
